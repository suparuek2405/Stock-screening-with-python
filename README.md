...
## Introduction
กลุ่มของเราต้องการศึกษาเกี่ยวกับกลยุทธ์การลงทุนว่าการลงทุนด้วยการกรองค่าสัดส่วนทางการเงินวิธีไหนจะสร้างผลตอบแทนมากที่สุด โดยในรายงานนี้เราจะใช้ข้อมูลงบการเงินจากปี 2020 ถึง 2022 ในการคัดกรองหุ้น แล้วนำมาคำนวณว่าหากเราซื้อหุ้นตามกลยุทธ์ โดยมีเงินทุน 1 ล้านบาท เราจะได้กำไรหรือขาดทุนเท่าไร โดยจำลองเริ่มซื้อหุ้นตั้งแต่่เดือนมีนาคม 2023 (ซึ่งเป็นช่วงที่ประกาศงบปี) 2022 จนถึงกันยายนปี 2024

## Data Source
ข้อมูลที่ใช้นำมาจาก yfinance ซึ่งเป็นไลบรารีใน Python ที่ใช้ดึงข้อมูลทางการเงินจาก Yahoo Finance เช่น ราคาหุ้น ข้อมูลบริษัท ประวัติราคา และข้อมูลตลาด เพื่อช่วยนักพัฒนาวิเคราะห์และทำงานเกี่ยวกับการลงทุน
